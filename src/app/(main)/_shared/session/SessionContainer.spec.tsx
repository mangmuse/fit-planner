...
jest.mock("@/app/(main)/_shared/session/SessionPlaceholder", () => {
...
jest.mock(
  ...
  () => {
    return function MockLoadPastSessionSheet() {
...
jest.mock(
  "@/app/(main)/_shared/session/sessionSequence/SessionSequence",
  () => {
    return function MockSessionSequence() {
...
describe("SessionContainer - 규정 테스트", () => {
