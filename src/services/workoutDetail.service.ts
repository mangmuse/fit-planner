...
//     try {
//       let workout = await workoutService.getWorkoutByUserIdAndDate(
//         userId,
//         date
//       );
...
//     try {
//       const details =
//         await workoutDetailRepository.findAllByWorkoutId(workoutId);
//       return details;
//     } catch (e) {
//       throw new Error("WorkoutDetails를 불러오는 데 실패했습니다");
//     }
...
//   // add
//   async addLocalWorkoutDetail(detailInput: LocalWorkoutDetail): Promise<void> {
//     try {
...
//   async addLocalWorkoutDetailsByWorkoutId(
//     workoutId: number,
//     startOrder: number,
...
//   async addSetToWorkout(lastSet: LocalWorkoutDetail): Promise<number> {
//     try {
//       const addSetInput =
...
//   async addLocalWorkoutDetailsByUserDate(
//     userId: string,
//     date: string,
...
//   async updateLocalWorkoutDetail(
...
//   async updateWorkoutDetails(updatedDetails: LocalWorkoutDetail[]) {
//     try {
...
//   // delete
//   async deleteWorkoutDetail(lastSetId: number): Promise<void> {
//     try {
...
//   async deleteWorkoutDetails(details: LocalWorkoutDetail[]): Promise<void> {
//     try {
//       await Promise.all(
...
// };
// const syncService = {
//   async overwriteWithServerWorkoutDetails(userId: string): Promise<void> {
//     const serverData: ClientWorkoutDetail[] =
//       await workoutDetailApi.fetchWorkoutDetailsFromServer(userId);
...
//   },
//   async syncToServerWorkoutDetails(): Promise<void> {
...
//     const data =
//       await workoutDetailApi.postWorkoutDetailsToServer(mappedUnsynced);
...
//     }
//   },
//   async _getAllDoneDetailsExceptCurrent(
...
//     }
//   },
//   async _pickMostRecentDetailBeforeDate(
...
//     try {
//       const isWorkout = isWorkoutDetails(details);
//       const candidates = await this._getAllDoneDetailsExceptCurrent(details);
...
//       }
//       const mostRecent = await this._pickMostRecentDetailBeforeDate(
//         candidates,
//         referenceDate
//       );
//       return mostRecent;
...
// export const workoutDetailService = {
//   ...coreService,
//   ...syncService,
//   ...queryService,
// };
